...
<div class="<?php echo esc_attr($wrapper_data['classes']); ?>" 
    ...
    <div class="team-members-content">
        ...
        <?php
            ...
            switch ($card_style) {
                case 'elevated':
                    $card_classes .= 'bg-white rounded-xl shadow-lg hover:shadow-xl p-6';
                    break;
                case 'bordered':
                    $card_classes .= 'bg-white rounded-xl border-2 border-gray-200 hover:border-blue-300 p-6';
                    break;
                case 'minimal':
                    $card_classes .= 'bg-white p-6';
                    break;
                case 'gradient':
                    $card_classes .= 'bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md hover:shadow-lg p-6';
                    break;
                default:
                    $card_classes .= 'bg-white rounded-xl shadow-lg hover:shadow-xl p-6';
            }
        ?>
            <div class="<?php echo esc_attr($grid_classes); ?>">
                <?php foreach ($members as $member) : 
                    ...
                    if ($is_featured) {
                        $final_card_classes .= ' ring-2 ring-blue-400 bg-blue-50 relative';
                    }
                ?>
                    <div class="<?php echo esc_attr($final_card_classes); ?>" data-member-id="<?php echo esc_attr($member_id); ?>">
                        ...
                        <div class="text-center">
                            ...
                            <div class="member-info">
                                ...
                                <?php if ($title) : ?>
                                    <p class="member-title text-lg font-medium text-blue-600 mb-2">
