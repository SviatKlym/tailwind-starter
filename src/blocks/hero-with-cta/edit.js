		...
		<>
			...
			<div {...blockProps}>
				<div className="hero-content-wrapper relative min-h-[400px] flex items-center">
					...
					{/* Content */}
					<div className={`hero-content relative z-10 w-full ${layout === 'split' ? 'grid grid-cols-1 lg:grid-cols-2 gap-8 items-center' :
						...
						<div className={`hero-text ${layout === 'split' ? 'lg:pr-8' : ''}`}>
							...
							<div className={`hero-cta-buttons flex gap-4 ${textAlignment === 'center' ? 'justify-center' :
